...
namespace _3DS_CivilSurveySuiteTests
{
    ...
    public class TraverseViewModelTests
    {
        ...
        public void CloseBearing_Property_Change()
        {
            ...
            var vm = new TraverseViewModel(mockService.Object, null, null);
        ...
        public void DrawCommand_Execute()
        {
            ...
            var vm = new TraverseViewModel(viewerService.Object, traverseService.Object, null);
        ...
        public void ShowHelpCommand_Execute()
        {
            ...
            var viewerService = new Mock<IViewerService>();
            var processService = new Mock<IProcessService>();

            var vm = new TraverseViewModel(viewerService.Object, traverseService.Object, processService.Object);
